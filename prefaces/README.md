...
- **Source language:** **Latin** (with Sanskrit in Devanāgarī and Roman transliteration, plus comparative Greek, Persian/Old-Persian, Lithuanian, Slavic, Celtic forms).
- **Scans:** Cologne csldoc, front-matter index → [boppref.html](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/boppref.html). Original page scans are kept under [`scans/`](scans/).
- The tiny digitizer running-header / footer stamps and the library accession stamp (`M-1126`, *Universität zu Köln, Seminar für Indologie*) are **not** part of the original and were omitted.

## File conventions

| Suffix | Meaning |
|---|---|
| `bopprefNN.md` | Page NN, Latin source transcription (original orthography preserved) |
| `bopprefNN.en.md` | English translation |
| `bopprefNN.ru.md` | Russian translation |
| `boppref_all.<lang>.md` | Consolidated single-file edition (all pages, with table of contents) |
| `build_combined.py` | Reproducible builder for the consolidated files (`DICT=bop python build_combined.py`) |
...
- The work is a single volume; all pages are vol. 1.
- **Title page** (p. 01): *GLOSSARIUM SANSCRITUM … a Francisco Bopp. Berolini … MDCCCXLVII* — the comparative-philology subtitle naming Greek, Latin, Germanic, Lithuanian, Slavic, Celtic.
