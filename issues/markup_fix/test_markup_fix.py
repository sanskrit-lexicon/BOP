"""Synthetic tests for 08_markup_fix.py (BOP)."""
...
line, n = fix_trim_whitespace("<lang> word </lang>")
check("<lang> trim", line, "<lang>word</lang>")
check("<lang> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<lang>clean</lang>")
check("<lang> no-op", line, "<lang>clean</lang>")
check("<lang> no-op n", n, 0)
